...
const eventsData = [
  ...
  },
  {
    ...
    speakers: [
      { name: 'Dr. Jonah Ellis', affiliation: 'UK', avatar: 'https://placehold.co/40x40/E2E8F0/4A5568?text=JE' },
...
const EventsSection = () => {
  return (
    <section className="font-sans bg-white py-16 sm:py-12">
      <div className="container mx-auto px-6 md:px-16 lg:px-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {eventsData.map((event) => {
            ...
            return (
              <div key={event.id} className="bg-gray-50 rounded-3xl overflow-hidden   flex flex-col h-full">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="bg-white rounded-2xl p-3 flex justify-center items-center gap-x-8 text-sm my-4">
                      ...
                      {event.time === 'On Demand' ? (
                          ...
                          <div className="flex items-baseline gap-2">
                              <span className="text-xl font-bold text-black">{event.time.split(' ')[0]}</span>
